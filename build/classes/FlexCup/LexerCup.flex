...
/* Tipos de datos */
( inter | dec | cad ) {return new Symbol(sym.Reservado, yychar, yyline, yytext());}

/* Tipo de dato Int (Para el main) */
( inter ) {return new Symbol(sym.Inter, yychar, yyline, yytext());}
...
/* Operadores logicos */
( "AND" | "OR" | "DIFERENTE" | "Y" | "O" ) {return new Symbol(sym.Operador_logico, yychar, yyline, yytext());}
...
/* Punto y coma */
( "$" ) {return new Symbol(sym.Finalizador, yychar, yyline, yytext());}
